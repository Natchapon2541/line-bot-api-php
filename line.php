 ...
 foreach ($request_array['events'] as $event)
 {
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "ข้อมูลส่วนตัวของผู้พัฒนาระบบ")||($text == "ข้อมูลส่วนตัวของผู้พัฒนาระบบ")||($text == "ข้อมูลส่วนตัวของผู้พัฒนาระบบ")){
			$reply_message = 'ชื่อนายณัชพล ศรีวิสุทะิ์ อายุ 21ปี น้ำหนัก 92kg. สูง 177cm. ขนาดรองเท้าเบอร์ 10';
		}
		else if(($text== "อยากทราบยอด COVID-19 ครับ")||($text== "อยากทราบยอด COVID-19 ครับ")||($text== "อยากทราบยอด COVID-19 ครับ")||($text== "อยากทราบยอด COVID-19 ครับ")){
